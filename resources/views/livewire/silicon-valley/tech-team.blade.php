<div class="border-b border-white text-white bg-sv-gradient-bottomtop py-10">
    ...
    <div class="p-6 max-w-5xl mx-auto text-center">
        <h2 class="text-center text-white md:text-3xl text-2xl font-bold mb-10">{ Enhance Your Technology Team With Our Experts }</h2>
        ...
        <div class="md:grid grid-cols-3 gap-10 py-20">
            <div class="flex aspect-[1/1] rounded-2xl overflow-hidden p-2 relative">
            ...
            <div class="flex aspect-[1/1] rounded-2xl p-2 relative overflow-hidden">
